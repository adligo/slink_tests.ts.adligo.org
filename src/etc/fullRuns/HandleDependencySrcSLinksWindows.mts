...
export class HandleDependencySrcSLinksWindows extends ApiTrial {
  public static testHandleDependencySrcSLinks: Test = new Test(TestParams.of(
    'org.adligo.ts.slink_tests.HandleDependencySrcSLinksWindows.' +
    'testHandleDependencySrcSLinks').ignore(), (ac: I_AssertionContext) => {
      
    ac.isTrue(false, "TODO this code was generated by AI and needs auditing");
    // Setup
    const ctxParams = new CliCtxMockParams();
    ctxParams._windows = true;
  ...
  constructor() {
    super('HandleDependencySrcSLinksWindows', [HandleDependencySrcSLinksWindows.testHandleDependencySrcSLinks]);
  }
}
