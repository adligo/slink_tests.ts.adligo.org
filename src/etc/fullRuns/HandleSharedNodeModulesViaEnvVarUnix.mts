...
export class HandleSharedNodeModulesViaEnvVarUnix extends ApiTrial {
  public static testHandleSharedNodeModulesViaEnvVar: Test = new Test(TestParams.of(
    'org.adligo.ts.slink_tests.HandleSharedNodeModulesViaEnvVarUnix.' +
    'testHandleSharedNodeModulesViaEnvVar').ignore(), (ac: I_AssertionContext) => {
    ...
    // TODO don't patch the env this way, bad AI
  ...
  public static testFullRunWithSharedNodeModulesViaEnvVar: Test = new Test(TestParams.of(
    'org.adligo.ts.slink_tests.HandleSharedNodeModulesViaEnvVarUnix.' +
    'testFullRunWithSharedNodeModulesViaEnvVar'), (ac: I_AssertionContext) => {
    ...
    procMock._env["TEST_NODE_MODULE_SLINK"] = "/omock/shared_deps_foo/node_modules";
    ...
    fscParams._ac = ac;
    const omockSharedDeps = Paths.newPath('/omock/shared_deps_foo', false, false);
    const omockSharedDepsPackageJson = Paths.newPath('/omock/shared_deps_foo/package.json', false, false);
    const omockSharedDepsNodeModules = Paths.newPath('/omock/shared_deps_foo/node_modules', false, false);
  ...
  constructor() {
    super('HandleSharedNodeModulesViaEnvVarUnix', [HandleSharedNodeModulesViaEnvVarUnix.testHandleSharedNodeModulesViaEnvVar, HandleSharedNodeModulesViaEnvVarUnix.testFullRunWithSharedNodeModulesViaEnvVar]);
  }
}
