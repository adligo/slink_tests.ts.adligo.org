...
export class HandleSharedNodeModulesViaEnvVarUnix extends ApiTrial {
  public static readonly TESTS: I_Test[] = [
    ...
    new Test(TestParams.of('testFullRunWithSharedNodeModulesViaEnvVar'), (ac: I_AssertionContext) => {
  ...
  constructor() {
    super('HandleSharedNodeModulesViaEnvVarUnix', HandleSharedNodeModulesViaEnvVarUnix.TESTS);
  }
}
