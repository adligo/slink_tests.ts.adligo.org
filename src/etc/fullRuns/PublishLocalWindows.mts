...
export class PublishLocalWindows extends ApiTrial {
  public static testPublishLocalSuccess: Test = new Test(TestParams.of(
    'org.adligo.ts.slink_tests.PublishLocalWindows.' +
    'testPublishLocalSuccess').ignore(), (ac: AssertionContext) => {
  ...
  public static testPublishLocalNoNodeModules: Test = new Test(TestParams.of(
    'org.adligo.ts.slink_tests.PublishLocalWindows.' +
    'testPublishLocalNoNodeModules').ignore(), (ac: AssertionContext) => {
  ...
  public static testPublishLocalNotSymlink: Test = new Test(TestParams.of(
    'org.adligo.ts.slink_tests.PublishLocalWindows.' +
    'testPublishLocalNotSymlink').ignore(), (ac: AssertionContext) => {
  ...
  public static testPublishLocalNoPackageJson: Test = new Test(TestParams.of(
    'org.adligo.ts.slink_tests.PublishLocalWindows.' +
    'testPublishLocalNoPackageJson').ignore(), (ac: AssertionContext) => {
  ...
  public static testPublishLocalWithExistingPackage: Test = new Test(TestParams.of(
    'org.adligo.ts.slink_tests.PublishLocalWindows.' +
    'testPublishLocalWithExistingPackage').ignore(), (ac: AssertionContext) => {
  ...
  constructor() {
    super('PublishLocalWindows', [
      PublishLocalWindows.testPublishLocalSuccess,
      PublishLocalWindows.testPublishLocalNoNodeModules,
      PublishLocalWindows.testPublishLocalNotSymlink,
      PublishLocalWindows.testPublishLocalNoPackageJson,
      PublishLocalWindows.testPublishLocalWithExistingPackage
    ]);
  }
}
