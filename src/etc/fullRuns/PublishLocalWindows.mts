...
export class PublishLocalWindows extends ApiTrial {
  public static readonly TESTS: I_Test[] = [
    new Test(TestParams.of('testPublishLocalSuccess').ignore(), (ac: I_AssertionContext) => {
    ...
    new Test(TestParams.of('testPublishLocalNoNodeModules').ignore(), (ac: I_AssertionContext) => {
    ...
    new Test(TestParams.of('testPublishLocalNotSymlink').ignore(), (ac: I_AssertionContext) => {
    ...
    new Test(TestParams.of('testPublishLocalNoPackageJson').ignore(), (ac: I_AssertionContext) => {
    ...
    new Test(TestParams.of('testPublishLocalWithExistingPackage').ignore(), (ac: I_AssertionContext) => {
  ...
  constructor() {
    super('PublishLocalWindows', PublishLocalWindows.TESTS);
  }
}
