...
export class FxContextManualApiTrial extends ApiTrial {
  public static readonly TESTS: I_Test[] = [
    new Test('testExistsAbs', (ac: I_AssertionContext) => {
    ...
    new Test('testExists', (ac: I_AssertionContext) => {
     ...
     */
    new Test = new Test('testMkSymlink', (ac: I_AssertionContext) => {
      ac.isTrue(fsc.exists('test_data', pCwd),
        "The test_data should show as exist");
  ...
  constructor() {
    super('org.adligo.ts.slink_tests.FxContextManualApiTrial', FxContextManualApiTrial.TESTS);
  }
}
