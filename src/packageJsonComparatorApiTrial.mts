...
export class PackageJsonComparatorApiTrial extends ApiTrial {
  ...
  public static TESTS: I_Test[] = [
    new Test('testZeroDeps', (ac: I_AssertionContext) => {
      let projectJson = {};
    ...
    new Test('testTwoMissing', (ac: I_AssertionContext) => {
    ...
    new Test('testTwoWrong', (ac: I_AssertionContext) => {
      let projectJson = { dependencies: { foo: 'bar' }, devDependencies: { xyz: '123' } };
      const projectRoot: Path = Paths.newPath('Z:/mock/current/project', false, true);
      const projectRootPackageJson: Path = Paths.newPath('Z:/mock/current/project/package.json', false, true);
    ...
    new Test('testTwoMissingAndThreeWrong', (ac: I_AssertionContext) => {
    ...
    new Test('testSwapMatch', (ac: I_AssertionContext) => {
      let projectJson = { dependencies: { foo: 'bar' }, devDependencies: { xyz: '123' } };
      const projectRoot: Path = Paths.newPath('Z:/mock/current/project', false, true);
      const projectRootPackageJson: Path = Paths.newPath('Z:/mock/current/project/package.json', false, true);
  ...
  constructor() {
    super('org.adligo.ts.slink_tests.PackageJsonComparatorApiTrial', PackageJsonComparatorApiTrial.TESTS);
  }
}
